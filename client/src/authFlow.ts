 ...
 * origin exactly matches one of the platform apps, the account app itself or
 * the portfolio site, otherwise null (→ stay here, on the account dashboard).
 * Open-redirect guard.
 */
